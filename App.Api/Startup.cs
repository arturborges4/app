...
namespace App.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            Persistense.DependencyInjectionConfig.Inject(services);
            Application.DependecyInjectionConfig.Inject(services);
            Infraestructure.DependencyInjectionConfig.Inject(services);
        }
